 ...
 * @version $Id$
 */
public class SalesChannelDaoHibernateImpl extends
        AbstractSimpleDaoHibernateImpl<SalesChannel> implements SalesChannelDao {
    ...
    protected static Log log = LogFactory
            .getLog(SalesChannelDaoHibernateImpl.class);
